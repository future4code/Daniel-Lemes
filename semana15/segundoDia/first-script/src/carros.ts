...
// //     volumeDoTanque: 61,
// //     temMotorFlex: false,
// //     calculaAutonomia: (combustivelRestante: number)=>  {
...
// //     }
// // }
// // const frota: carro[] = [mustang, gol, kombi]


// //   const buscarCarrosPorMarca = (frota: carro[], marca?: string): carro[] => {
// //     if (marca === undefined) {
// //         return frota
// //     }
// //     return frota.filter(
...
// //     )
// // }
// // console.table(buscarCarrosPorMarca(frota))
...
//  console.log(kombi.calculaAutonomia(20))